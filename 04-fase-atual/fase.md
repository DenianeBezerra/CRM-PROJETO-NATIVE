# Fase 1 — Fundação e CRM configurável
...
| ----- | --------------------------------------------------------------- | -------------------------- | ------------------- | ------------------------- |
| T1.1  | Acesso, sessão e perfis operacionais — caminho principal        | Executor de software/dados | SPEC-1-001          | ✅ Concluída — 2026-09-04 |
...
| T12.1 | Exportação segura e aceite integrado — caminho principal        | Executor de software/dados | SPEC-1-012-DERIVADA | ✅ Concluída — 2026-09-08 |
| T12.2 | Exportação e aceite — bordas e regressão                        | Verificador da entrega     | SPEC-1-012          | ☐ Planejada               |

**Contagem:** 17 de 24 tasks concluídas (70,83%).
