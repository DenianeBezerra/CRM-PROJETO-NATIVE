migrate(
  (app) => {
    // T2.33 — revalidação independente (conclusão): a prova GREEN1 deixou o
    // handoff real em "devolvido". Estado final: pendente, checklist padrão,
    // sem resíduo de decisão.
