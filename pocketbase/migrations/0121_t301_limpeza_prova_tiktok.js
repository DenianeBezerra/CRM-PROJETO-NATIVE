migrate(
  (app) => {
    // T3.01 — limpeza do negócio de prova "T301-PROVA-tiktok-final" (delete
    // via API bloqueado por relation/403). Ordem: handoffs → tarefas →
    // propostas → permanências → negócio. Idempotente.
    try {
