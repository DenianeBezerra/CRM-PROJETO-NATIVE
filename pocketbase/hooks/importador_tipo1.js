...
function processar(linhasA, linhasB, dedup) {
  ...
  for (var i = 0; i < linhasA.length; i++) {
    ...
    if (!natureza) err.push('natureza_registro obrigatória (cliente | empresa do grupo | projeto)')
  ...
  for (var b = 0; b < linhasB.length; b++) {
    ...
    if (empresaAlvo && emailB && emailB === empresaAlvo.contato_email) itemB.mesmo_principal = true
