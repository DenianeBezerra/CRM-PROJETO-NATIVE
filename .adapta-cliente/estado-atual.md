...
- nota_roteiro: 1a versao do roteiro pedia Kanban + handoff na UI — a UI NAO tem tela de handoff (decisao T2.33 testada por API); roteiro corrigido: re-ganho via edicao da oportunidade em /oportunidades + conferencia do handoff por API feita pelo champion
