...
- ultima_acao: T3.18 implementada (v0.0.563 QA verde) — RED 5/GREEN por API na base real, regressão ok, limpeza (meta de prova desativada), evidência em evidencias/spec-3-018/
