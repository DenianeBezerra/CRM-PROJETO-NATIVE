...
- pendencias: (1) RBAC social_media por regra de coleção (0189/0190/0191) não aplicou no pod — bloqueio funciona nas rotas de hook, mas listagem direta de negócios/obrigações ainda 200 para o papel; investigar com superuser; (2) sync GitHub da governança pendente; (3) teste humano da Leva A pendente (regra da leva: executado pela Deni.Ai).
- proxima_acao: teste humano da Leva A + sync GitHub + investigar RBAC de coleção
- atualizado_em: 2026-09-14T09:50:00-03:00
