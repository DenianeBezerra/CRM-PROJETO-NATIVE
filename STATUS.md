...
**Task ativa:** T3.21 — Módulo de Conteúdo (Leva A concluída; Leva B autorizada — calendário em implementação)
...
**Versão atual:** v0.0.621 (QA verde — M-19 ampliado + governança)
...
| 21   | T3.21 — Módulo de Conteúdo (Leva A concluída; Leva B autorizada — calendário → busca → anual) | SPEC-3-021/021B | ◐ Em execução — Leva A concluída 13/09; Leva B autorizada |
...
- 13 obrigações (12 previstas + 1 bloqueada); exceções órfãs resolvidas (0199) — 0 abertas.
...
- Peça real "Split payment no Simples: o que muda em 2026" PUBLICADA (validação ponta a ponta do módulo de conteúdo; campanha D17 2026-cfo-split-payment).
- 4 peças de prova arquivadas e marcadas [PROVA T3.21]; 2 campanhas de prova encerradas.
