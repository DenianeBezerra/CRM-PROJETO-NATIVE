...
**Versão atual:** v0.0.655 (QA verde — governança sincronizada; tipo 1 testado)
...
| 22   | T3.22 — Importador por planilha (3 tipos) — SPEC v3 autorizada; implementando tipo 1 isolado (migração fora dos indicadores; múltiplos serviços c/ valor próprio; sistema de gestão + serviços obrigatórios) | SPEC-3-022 | ◐ Tipo 1 TESTADO (Deni.Ai 13/09, ciclo completo + migração provada; base limpa) — tipos 2/3 em sequência |
...
- Importador tipo 1 implementado e TESTADO (/importador): pré-visualização rejeita CNPJ inválido/sem serviço, ciclo gravar→desfazer provado na UI, migração CA-3-115 provada via API (entrada_origem=migracao, data_ganho=data_inicio, um negócio por serviço); base limpa (0 registros de prova).
