...
**Task ativa:** T3.20 — Causas comuns C-03 + C-01 + C-04 (SPEC-3-020) — aguardando autorização
**Última task concluída:** T3.19 — Relatórios agendados (2026-09-14 08:15, teste humano aprovado pela CEO — "prossiga"; v0.0.571)
**Versão atual:** v0.0.573 (QA verde — SPEC-3-020 publicada)
...
| 20   | T3.20 — Causas comuns C-03 + C-01 + C-04 (Direcionamento de Correções v2, ordem 1-2)                             | SPEC-3-020            | 🕐 Aguardando autorização da CEO                              |
