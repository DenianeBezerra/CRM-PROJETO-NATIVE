...
**Task ativa:** T3.17 — Modelo de contrato no CRM (SPEC-3-017) — aguardando autorização
...
**Versão atual:** v0.0.543 (QA verde — governança)
...
| 17   | T3.17 — Modelo de contrato no CRM (passo anterior ao ClickSign)               | SPEC-3-017            | 🕐 Aguardando autorização da CEO |
