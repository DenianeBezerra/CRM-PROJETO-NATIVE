...
**Task ativa:** T3.18 — Painel por papel + metas editáveis (SPEC-3-018) — aguardando autorização
...
| 18   | T3.18 — Painel por papel + metas editáveis (backlog Etapa 3, camada analítica p.1)                      | SPEC-3-018            | 🕐 Aguardando autorização da CEO |
