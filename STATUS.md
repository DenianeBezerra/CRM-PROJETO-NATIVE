...
**Versão atual:** v0.0.563 (QA verde — provas + limpeza + governança)
...
| 19   | T3.19 — Relatórios agendados (backlog Etapa 3, §2.3)                                                    | SPEC-3-019            | 🕐 Aguardando teste humano da CEO (v0.0.570) |
| 19   | T3.19 — Relatórios agendados (backlog Etapa 3, §2.3)                                                    | SPEC-3-019            | 🕐 Aguardando autorização da CEO             |
| 14+  | E1–E9 (conector OMIE), Leva C da ficha, relatórios agendados, V.ia, perfis/backup, integração ClickSign | a definir SPEC a SPEC | Planejadas                                   |
