...
**Task ativa:** T3.17 — Modelo de contrato no CRM (SPEC-3-017) — implementada, aguardando teste humano
...
**Versão atual:** v0.0.555 (QA verde)
...
| 17   | T3.17 — Modelo de contrato no CRM (passo anterior ao ClickSign)               | SPEC-3-017            | 🕐 Aguardando teste humano da CEO |
